#![deny(warnings)]
//! The upstream echo example extended to use a Jaeger subscriber.
//!
//! This example uses the current development version of the
//! `tracing-attributes-http` Crate.
//!
//! See [`./examples/echo_trace/`](./examples/echo_trace/), for an example of
//! patching a project such that Hyper uses your implementation of
//! `TraceableError` handling.
//!
